...
char g_alphabet_16x32[CHAR_MAX][64] =
{
    ...
    {0x1C,0x0C,0x1E,0x18,0x13,0xE0,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},/*"b",1*/
    ...
    {0x18,0x08,0x0C,0x10,0x03,0xE0,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},/*"c",2*/
    ...
    {0x18,0x38,0x0C,0x5E,0x07,0x90,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},/*"d",3*/
    ...
    {0x18,0x08,0x0E,0x18,0x03,0xE0,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},/*"e",4*/
    ...
    {0x03,0x00,0x03,0x00,0x1F,0xF0,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},/*"f",5*/
    ...
    {0x0F,0xF0,0x0F,0xFC,0x10,0x0E,0x30,0x06,0x30,0x06,0x30,0x06,0x1C,0x1C,0x07,0xF0},/*"g",6*/
    ...
    {0x18,0x0C,0x18,0x0C,0x7E,0x3F,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},/*"h",7*/
    ...
    {0x00,0x18,0x00,0x18,0x00,0x18,0x00,0x18,0x00,0x18,0x18,0x30,0x18,0x60,0x0F,0xC0},/*"j",9*/
    ...
    {0x18,0x38,0x18,0x18,0x7E,0x3E,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},/*"k",10*/

    {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x80,0x1F,0x80,0x01,0x80},
    {0x01,0x80,0x01,0x80,0x01,0x80,0x01,0x80,0x01,0x80,0x01,0x80,0x01,0x80,0x01,0x80},
    {0x01,0x80,0x01,0x80,0x01,0x80,0x01,0x80,0x01,0x80,0x01,0x80,0x01,0x80,0x01,0x80},
    {0x01,0x80,0x01,0x80,0x1F,0xF8,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},/*"l",11*/
    ...
    {0x31,0x8C,0x31,0x8C,0x7B,0xDE,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},/*"m",12*/

    {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x08,0x00,0x78,0xF0,0x1B,0x18,0x1C,0x0C},
    {0x18,0x0C,0x18,0x0C,0x18,0x0C,0x18,0x0C,0x18,0x0C,0x18,0x0C,0x18,0x0C,0x18,0x0C},
    {0x18,0x0C,0x18,0x0C,0x7E,0x3F,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},/*"n",13*/
    ...
    {0x18,0x0C,0x0C,0x18,0x03,0xE0,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},/*"o",14*/
    ...
    {0x1C,0x0C,0x1E,0x18,0x19,0xE0,0x18,0x00,0x18,0x00,0x18,0x00,0x18,0x00,0x7E,0x00},/*"p",15*/
    ...
    {0x18,0x1C,0x0C,0x3C,0x07,0xCC,0x00,0x0C,0x00,0x0C,0x00,0x0C,0x00,0x0C,0x00,0x3F},/*"q",16*/
    ...
    {0x06,0x00,0x06,0x00,0x7F,0xE0,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},/*"r",17*/
    ...
    {0x30,0x0C,0x38,0x18,0x37,0xF0,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},/*"s",18*/
    ...
    {0x03,0x04,0x01,0x88,0x00,0xF0,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},/*"t",19*/

    {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
    {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x08,0x04,0x78,0x3C,0x18,0x0C,0x18,0x0C},
    {0x18,0x0C,0x18,0x0C,0x18,0x0C,0x18,0x0C,0x18,0x0C,0x18,0x0C,0x18,0x0C,0x18,0x0C},
    {0x18,0x1C,0x0C,0x2F,0x07,0xC8,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},/*"u",20*/
    ...
    {0x03,0x80,0x03,0x00,0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},/*"v",21*/
    ...
    {0x0E,0x70,0x04,0x20,0x04,0x20,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},/*"w",22*/
    ...
    {0x08,0x30,0x18,0x18,0x7C,0x7E,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},/*"x",23*/
    ...
    {0x01,0x80,0x01,0x80,0x01,0x80,0x01,0x00,0x01,0x00,0x01,0x00,0x32,0x00,0x3C,0x00},/*"y",24*/
    ...
    {0x1C,0x0C,0x38,0x18,0x3F,0xF8,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},/*"z",25*/
};
...
int display_classname_bmp_create(void)
{
    ...
    for (class_id = 0; class_id < OBJDETECTS_CLASS_NUM; ++class_id)
    {
        ...
        for (char_idx = 0; char_idx < name_len; ++char_idx)
        {
            ...
            bmp_fill_addr = g_dis_handle.label_bmp[class_id] + char_idx * FONT_SIZE;
            ...
            for (row_idx = 0; row_idx < FONT_SIZE; ++row_idx)
            {
                ...
                {
                    char word_module = *(font_model_addr + row_idx * (FONT_WIDTH / 8) + (column_idx / 8));
                    for (bit = 0; bit < 8; ++bit)
                    {

...
#define VPSS_JPEG_CHN           0       // 1        使用通道1开遮挡告警的时候会出现 VPSS_AddRotateCallBack assert错误导致内核崩溃
#define VPSS_MAIN_CHN           3 /* 只有 vpsschn 3 才能实现从4M到1080p的缩放 */

#define VPSS_AUX_CHN            2
#define VPSS_ALG_CHN            1   // 0  /* vpsschn 0 无法进行缩放，必须和chngrp的一致 */
